                ...
                <div class="panel-body">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="checkbox">
                                <label>
                                    <input name="prd_featured" type="checkbox" <?php if($row["prd_featured"]==1){echo "checked";}?> value=1>Nổi bật
                                </label>
                            </div>
                        </div>
                        <div class="form-group">
                            <label>Mô tả sản phẩm</label>
                            <textarea name="prd_details" id="prd_details" required class="form-control" rows="3"><?php echo $row["prd_details"]; ?></textarea>
                            <script>
